...
public class RPSLSpock {
    ...
    /**
     * @param pick The valid values for picks
     * @return This returns one of those five choices
     */
    ...
    /**
     * @return this returns the computer's random choice
     */
     ...
     * @param h_pick the human's input
     * @return this returns if the computer or lost
     */
